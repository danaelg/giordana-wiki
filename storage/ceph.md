...
# Introduction
Ceph est une technologie de stockage distribué libre qui fournit du [stockage objet](/storage/object), [block](/storage/block) et sous forme de [système de fichiers](/filesystem) ([CephFS](/filesystem/cephfs)).
